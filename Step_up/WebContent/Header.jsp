...
<header>
	...
	<div id = "icon-container">
		<a href = "../userlogging/Wishlist.jsp"><img id = "iconw" src = "images/icon_wishlist2.png" width = "50" height = "50" onmouseout = "document.getElementById('iconw').src='images/icon_wishlist2.png'" onmouseover = "document.getElementById('iconw').src='images/icon_wishlist_focus.png'"></a>
		<a href = "../userlogging/Profilo.jsp"><img id = "iconp" src = "images/icon_profile2.png" width = "50" height = "50" onmouseout = "document.getElementById('iconp').src='images/icon_profile2.png'" onmouseover = "document.getElementById('iconp').src='images/icon_profile_focus.png'"></a>
